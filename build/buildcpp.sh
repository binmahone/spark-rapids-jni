...
echo "parallel level: $CPP_PARALLEL_LEVEL"
...
# print following variables for debugging

echo "debugging"
echo "CUDF_CPP_BUILD_DIR=$LIBCUDF_BUILD_PATH"
echo "CUDF_ROOT=$CUDF_PATH"
echo "CUDF_INSTALL_DIR=$LIBCUDF_INSTALL_PATH"
echo "CUDFJNI_BUILD_DIR=$LIBCUDFJNI_BUILD_PATH"
echo "BUILD_BENCHMARKS=$BUILD_BENCHMARKS"
echo "BUILD_FAULTINJ=$BUILD_FAULTINJ"
echo "BUILD_PROFILER=$BUILD_PROFILER"
echo "BUILD_TESTS=$BUILD_TESTS"
echo "CUDF_DEPENDENCY_PIN_MODE=pinned"
echo "CUDF_USE_PER_THREAD_DEFAULT_STREAM=$CUDF_USE_PER_THREAD_DEFAULT_STREAM"
echo "GPU_ARCHS=$GPU_ARCHS"
echo "RMM_LOGGING_LEVEL=$RMM_LOGGING_LEVEL"
echo "USE_GDS=$USE_GDS"
echo "CMAKE_CONFIG=$CUDF_PIN_PATH/setup.cmake"
